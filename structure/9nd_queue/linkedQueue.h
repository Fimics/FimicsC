...
template<class T>
linkedQueue<T>::~linkedQueue() {// Destructor.
...
template<class T>
void linkedQueue<T>::pop() {// Delete front element.
    if (queueFront == NULL)
        throw queueEmpty();
...
template<class T>
void linkedQueue<T>::push(const T &theElement) {// Add theElement to back of queue.
